...
<style>
    ...
    .nlp-display-scroll-entities {{
        border: 1px solid #E7EDF0;
        border-radius: 3px;
        text-align: justify;
        
    }}
    .nlp-display-scroll-entities span {{  
        font-size: 14px;
        line-height: 24px;
        color: #536B76;
